...
whitmantext = csv.reader(open('../data/cleanedWhitmanData.txt'))
fileToWrite = csv.writer(open('../data/dataWithCities.txt','w+'),delimiter = ',');
dataFile = csv.reader(open('../data/sortedCities.txt','r'),delimiter = ',');
