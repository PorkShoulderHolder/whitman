...
##example from whitmanjson.json
    ...
    {
       "taggedHeading":[         /* this is the heading of the letter after being processed by nltk's pos (parts of speech) tagger */
          [
             [
                "Letter",
                "NNP"
       ...
       "people":[           /* this is what the named entity recognizer came up with for what it thought were people */
          "Dear",
          "Mr. House2",
          "Bardic Symbols",
          "Mr. House",
       ...
       "month":"Jan",
       "parties":[          /* compilation of sender, recipient, and other organixations named in the letter
          "Walt Whitman",
       ...
       "latlngs":[          /* latitude and longitude generated by the detected locations cross referenced with a list of
                               american cities and then passed into the google geotagging api */
          [
             40.65,
             -73.95
          ]
       ...
       "recipient":"James Russell Lowell",      /* Named entity recognition performed on the heading gives us a sender and a recipient */
       "organizations":[
